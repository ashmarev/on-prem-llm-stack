# RTX2080Ti
## Цель исследования
Показать как эффективно использовать LLM в условиях ограниченной инфраструктуры (на примере 1 GPU). NVLink присутствует, но не используется в рамках данного теста.
## Вывод
